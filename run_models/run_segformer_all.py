...
CONFIGS_TO_RUN = [
    ...
    PROJECT_ROOT / "configs" / "experiments" / "glenda_segformer_trained.yaml",
    PROJECT_ROOT / "configs" / "experiments" / "glenda_clean_segformer_trained.yaml",
]
...
def main():
    print("=" * 100)
    print("Running SegFormer baseline experiments")
    ...
    print("\nAll selected SegFormer experiments finished.")

    print("\n" + "=" * 100)
    print("Visualizing SegFormer metrics")
    print("=" * 100)
        ...
        for split in SPLITS_TO_VISUALIZE:
            try:
                ...
                print(
                    ...
                    f"{dataset_name} | SegFormer | {split}: {error}"
                )

    print("\nAll selected SegFormer experiments and visualizations finished.")
